...
import { Cloud, CloudOff, RefreshCw, AlertCircle, Check, LucideIcon } from 'lucide-react';
...
export const SyncStatusIcon: React.FC<SyncStatusIconProps> = ({
  ...
  const icons: Record<SyncStatus, LucideIcon> = {
