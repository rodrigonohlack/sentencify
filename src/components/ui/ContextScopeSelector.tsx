...
export const ContextScopeSelector: React.FC<ContextScopeSelectorProps> = ({
  ...
  return (
    <div className="space-y-3">
      ...
      <label className="flex items-center gap-3 mt-3 cursor-pointer p-3 rounded-lg border theme-border-input hover:border-purple-500/50 transition-all">
        <input
          type="checkbox"
          checked={includeMainDocs}
          onChange={(e) => setIncludeMainDocs(e.target.checked)}
          className="w-4 h-4 text-purple-600 rounded border-gray-400 focus:ring-purple-500 focus:ring-offset-0"
        />
        <div>
