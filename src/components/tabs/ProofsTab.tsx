          ...
          <div className="space-y-2">
            ...
            {isAuthenticated && (
              <button
                ...
                className="w-full py-3 rounded-lg transition-colors flex items-center justify-center gap-2 theme-bg-secondary theme-hover-bg border theme-border-input theme-text-primary"
              >
