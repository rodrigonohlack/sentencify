...
import type { GeminiThinkingLevel, OpenAIReasoningLevel, TokenMetrics, ClaudeCliEffort, CodexCliReasoning } from '../../../../types/ai';
...
const MODEL_PRICES = {
  ...
  // v1.43.10: DeepSeek V4 Flash (opção mais barata do menu)
              ...
              {deepseekThinking !== false && (
                <div>
                  ...
                  >
                    ...
                    <option value="max">Max (tarefas agênticas complexas)</option>
                  </select>
                </div>
              )}
              <p className="text-xs text-slate-500 dark:text-slate-400">
                DeepSeek V4 liga thinking por padrão. Desligue pra tarefas simples (mais rápido/barato).
              </p>
            </div>
          )}
        </div>
