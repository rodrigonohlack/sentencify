  ...
  return (
    <div className="glass-card overflow-hidden p-0">
      <div className="flex items-center justify-between px-6 py-4 border-b border-indigo-500/10">
        <h3 className="text-base font-bold text-[#1e1b4b]">Preview da importação</h3>
        ...
        <table className="w-full border-collapse">
          <thead className="sticky top-0 bg-white/80 backdrop-blur-sm">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-[11px] font-semibold text-[#7c7caa] uppercase tracking-wider">Descrição</th>
          ...
          <tbody>
            {rows.map((row, i) => (
              ...
              >
                ...
                <td className="px-4 py-2.5 text-[11px] text-[#7c7caa]">{row.installment || 'Única'}</td>
