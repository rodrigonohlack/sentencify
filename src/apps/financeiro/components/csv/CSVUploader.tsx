...
export default function CSVUploader({ onUpload, isUploading }: CSVUploaderProps) {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className="glass-card flex flex-col items-center justify-center py-16 px-8 text-center border-2 border-dashed border-indigo-500/20 hover:border-indigo-500/40 transition-colors cursor-pointer"
    ...
    >
      ...
      <h3 className="text-lg font-bold text-[#1e1b4b] mb-2">Importar Fatura CSV</h3>
      <p className="text-sm text-[#7c7caa] max-w-sm mb-6">
