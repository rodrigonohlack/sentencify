...
export const DEFAULT_SOURCES: NewsSource[] = [
  ...
  { id: 'trt8',  name: 'TRT-8 (PA/AP)',      type: 'tribunal', /* feedUrl: 'https://www.trt8.jus.br/rss.xml' */   websiteUrl: 'https://www.trt8.jus.br',  enabled: false },  // Bloqueado pelo IP do Render (502)
