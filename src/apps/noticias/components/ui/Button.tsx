/**
 * @file Button.tsx
 * @description Componente de botão reutilizável para o app de Notícias
 */
...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 shadow-lg shadow-blue-500/25',
