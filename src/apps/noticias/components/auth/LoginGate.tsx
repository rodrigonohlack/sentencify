// ═══════════════════════════════════════════════════════════════════════════
// COMPONENTE - Gate de Autenticação
// v1.41.0 - Componente de autenticação para o App de Notícias
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            autoFocus
            className="w-full pl-11 pr-4 py-3 bg-slate-900/50 border border-slate-600 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:opacity-50"
          />
        </div>
      </div>
...
export const LoginGate: React.FC<LoginGateProps> = ({ children }) => {
  const { loading, isAuthenticated } = useAuthMagicLink();
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">
              Agregador inteligente de notícias trabalhistas
            </p>
          </div>
          ...
          <div className="text-center mt-6">
            <a
              href="/"
              className="text-slate-500 text-sm hover:text-blue-400 transition-colors flex items-center gap-2 justify-center"
            >
