...
**Version**: 1.37.12 | **File**: `src/App.tsx` (~0.59 MB) | **Runtime**: Standalone + Render
...
| Version | Feature |
|---------|---------|
| v1.37.12 | Fix "Gerar com IA" cache hit: força mudança de estado (clear→set) para disparar useEffect no segundo clique |
